...
document.addEventListener('DOMContentLoaded', () => {
  ...
  /* ---- 6. ENQUIRE NOW – smooth scroll to contact link ---- */
  ...
  console.log('%cVSA Coaching Institute | Pune', 'color:#e94560;font-size:1.2rem;font-weight:bold;');
  console.log('%cBuilt with ❤️ for student success.', 'color:#8890b0;font-size:0.9rem;');
});